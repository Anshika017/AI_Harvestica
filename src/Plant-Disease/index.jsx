...
const App = () => {
    ...
    useEffect(() => {
        // Optional: Set initial section based on URL params or other logic
    }, []);
...
const styles = {
    container: {
        backgroundImage: 'url("/background_har.jpg")', // Background image from public folder
        ...
        padding: '20px',
        textAlign: 'center',
        position: 'relative', // Ensure the overlay covers the full content
    },
    uploadContainer: {
        backgroundColor: 'rgba(0, 0, 0, 0.8)', // Fully black background with transparency
        padding: '20px',
        borderRadius: '8px',
        marginBottom: '20px',
        width: '100%',
    ...
    fileInput: {
        marginBottom: '20px', // Adds space below the file input
    },
    submitButton: {
